...
{
    [DbContext(typeof(FarmFertilizeContext))]
    partial class FarmFertilizeContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharedDomain.Entities.FarmComponents.Common.ReferencedFertilize", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RefFertilizeInfos", (string)null);
                });
            ...
            modelBuilder.Entity("SharedDomain.Entities.FarmComponents.FarmFertilize", b =>
                {
                    ...
                    b.ToTable("FarmFertilizes", (string)null);
                });
            ...
            modelBuilder.Entity("SharedDomain.Entities.FarmComponents.FarmFertilize", b =>
                {
                    b.HasOne("SharedDomain.Entities.FarmComponents.BaseComponent", null)
                        .WithOne()
                        .HasForeignKey("SharedDomain.Entities.FarmComponents.FarmFertilize", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SharedDomain.Entities.FarmComponents.Common.ReferencedFertilize", "Reference")
                        .WithMany("InUse")
