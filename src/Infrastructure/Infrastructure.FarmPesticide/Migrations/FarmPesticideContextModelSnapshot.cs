...
{
    [DbContext(typeof(FarmPesticideContext))]
    partial class FarmPesticideContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharedDomain.Entities.FarmComponents.Common.PesticideInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PesticideInfos", (string)null);
                });
            ...
            modelBuilder.Entity("SharedDomain.Entities.FarmComponents.FarmPesticide", b =>
                {
                    ...
                    b.Property<Guid?>("PesticideInfoId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PesticideInfoId");

                    b.ToTable("FarmPesticides", (string)null);
                });
            ...
            modelBuilder.Entity("SharedDomain.Entities.FarmComponents.FarmPesticide", b =>
                {
                    b.HasOne("SharedDomain.Entities.FarmComponents.BaseComponent", null)
                        .WithOne()
                        .HasForeignKey("SharedDomain.Entities.FarmComponents.FarmPesticide", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SharedDomain.Entities.FarmComponents.Common.PesticideInfo", null)
                        .WithMany("Uses")
                        .HasForeignKey("PesticideInfoId");
                });
