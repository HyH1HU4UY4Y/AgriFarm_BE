        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentRefId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    ...
                    MerchantId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    MerchantId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    PaymentDestinationId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    PaymentDestinationId1 = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Paymentts_Merchants_MerchantId1",
                        column: x => x.MerchantId1,
                        principalTable: "Merchants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Paymentts_PaymentDestinations_PaymentDestinationId1",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PaymentRefId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    ...
                    NotiPaymentId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    PaymenttId = table.Column<Guid>(type: "uuid", nullable: false),
                    NotiMerchantId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PaymentId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    PaymenttId = table.Column<Guid>(type: "uuid", nullable: true),
                    TranRefId = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    LastModify = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_Paymentts_PaymenttId",
                        column: x => x.PaymenttId,
                        principalTable: "Paymentts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_PaymenttId",
                table: "PaymentTransactions",
                column: "PaymenttId");

            migrationBuilder.CreateIndex(
                name: "IX_Paymentts_MerchantId1",
                table: "Paymentts",
                column: "MerchantId1");

            migrationBuilder.CreateIndex(
                name: "IX_Paymentts_PaymentDestinationId1",
                table: "Paymentts",
