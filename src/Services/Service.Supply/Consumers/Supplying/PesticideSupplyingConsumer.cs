...
{
    public class PesticideSupplyingConsumer : IConsumer<IntegrationEventMessage<SupplyingEvent>>
    {
        private IMapper _mapper;
        private IMediator _mediator;
        private ILogger<PesticideSupplyingConsumer> _logger;

        public PesticideSupplyingConsumer(IMapper mapper,
            IMediator mediator, ILogger<PesticideSupplyingConsumer> logger)
        {
            _mapper = mapper;
            _mediator = mediator;
            _logger = logger;
