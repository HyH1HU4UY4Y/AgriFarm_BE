...
{
    public class LandSupplyingConsumer : IConsumer<IntegrationEventMessage<SupplyingEvent>>
    {
        private IMapper _mapper;
        private IMediator _mediator;
        private ILogger<LandSupplyingConsumer> _logger;

        public LandSupplyingConsumer(IMapper mapper,
            IMediator mediator, 
            ILogger<LandSupplyingConsumer> logger)
        {
            _mapper = mapper;
            _mediator = mediator;
            _logger = logger;
