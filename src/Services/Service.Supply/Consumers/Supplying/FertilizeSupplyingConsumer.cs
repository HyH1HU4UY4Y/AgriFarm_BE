...
{
    public class FertilizeSupplyingConsumer : IConsumer<IntegrationEventMessage<SupplyingEvent>>
    {
        private IMapper _mapper;
        private IMediator _mediator;
        private ILogger<FertilizeSupplyingConsumer> _logger;

        public FertilizeSupplyingConsumer(IMapper mapper,
            IMediator mediator, 
            ILogger<FertilizeSupplyingConsumer> logger)
        {
            _mapper = mapper;
            _mediator = mediator;
            _logger = logger;
