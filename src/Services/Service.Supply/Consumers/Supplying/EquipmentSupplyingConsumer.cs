...
{
    public class EquipmentSupplyingConsumer : IConsumer<IntegrationEventMessage<SupplyingEvent>>
    {
        private IMapper _mapper;
        private IMediator _mediator;
        private ILogger<EquipmentSupplyingConsumer> _logger;

        public EquipmentSupplyingConsumer(IMapper mapper,
            IMediator mediator, 
            ILogger<EquipmentSupplyingConsumer> logger)
        {
            _mapper = mapper;
            _mediator = mediator;
            _logger = logger;
